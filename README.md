...
Icons with the Btrfs logo and monochrome versions of distro logos are included for refind-btfrs snapshots.  To set one as a custom icon edit '/etc/refind-btrfs.conf'
>
